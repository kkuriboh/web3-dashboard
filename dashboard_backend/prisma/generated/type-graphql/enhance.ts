...
const modelsInfo = {
  Game: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt"],
...
const outputsInfo = {
  ...
  GameGroupBy: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateUser: ["_count", "_avg", "_sum", "_min", "_max"],
  UserGroupBy: ["id", "name", "email", "password", "country", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  GameCountAggregate: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt", "_all"],
  GameAvgAggregate: ["id", "price", "OPId"],
  GameSumAggregate: ["id", "price", "OPId"],
  GameMinAggregate: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  GameMaxAggregate: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
...
const inputsInfo = {
  GameWhereInput: ["AND", "OR", "NOT", "id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "OP", "createdAt", "updatedAt"],
  GameOrderByWithRelationInput: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "OP", "createdAt", "updatedAt"],
  GameWhereUniqueInput: ["id"],
  GameOrderByWithAggregationInput: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  GameScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  ...
  GameCreateInput: ["name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt", "OP"],
  GameUpdateInput: ["name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt", "OP"],
  GameUpdateManyMutationInput: ["name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt"],
  ...
  GameCountOrderByAggregateInput: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  GameAvgOrderByAggregateInput: ["id", "price", "OPId"],
  GameMaxOrderByAggregateInput: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  GameMinOrderByAggregateInput: ["id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  ...
  GameCreateWithoutOPInput: ["name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt"],
  ...
  GameScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "developer", "category", "description", "price", "releaseDate", "image", "OPId", "createdAt", "updatedAt"],
  GameUpdateWithoutOPInput: ["name", "developer", "category", "description", "price", "releaseDate", "image", "createdAt", "updatedAt"]
};
